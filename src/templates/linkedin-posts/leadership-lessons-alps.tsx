...
const LeadershipLessonsAlpsPost = () => {
  // You can manually edit the iframe code below
  const linkedinEmbedCode = `
    <iframe src="https://www.linkedin.com/embed/feed/update/urn:li:share:7339579159720910848?collapsed=1" height="583" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>
  `;
...
export default LeadershipLessonsAlpsPost;